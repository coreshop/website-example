...
<div class="copyright">
    ...
    <div class="container">
        ...
        <ul class="pull-right list-inline">
            <li>
                <img src="/website/static/images/payment-icon/cirrus.png" alt="PaymentGateway" />
            </li>
            <li>
                <img src="/website/static/images/payment-icon/paypal.png" alt="PaymentGateway" />
            </li>
            <li>
                <img src="/website/static/images/payment-icon/visa.png" alt="PaymentGateway" />
            </li>
            <li>
                <img src="/website/static/images/payment-icon/mastercard.png" alt="PaymentGateway" />
            </li>
            <li>
                <img src="/website/static/images/payment-icon/americanexpress.png" alt="PaymentGateway" />
            </li>
        </ul>
