<div class="container shop checkout checkout-step-3">
    ...
    <div class="panel">
        <div class="panel-body">
            <!-- Form Starts -->
            <form action="<?=$this->url(array("lang" => $this->language, "act" => "address"), "coreshop_checkout", true)?>" method="post">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <a href="<?=$this->url(array("lang" => $this->language, "act" => "address", "redirect" => $this->url(array("lang" => $this->language, "act" => "address"))), "coreshop_user", true)?>" class="btn btn-default pull-left">
