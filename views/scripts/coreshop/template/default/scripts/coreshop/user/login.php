<div id="main-container" class="container">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?=\CoreShop::getTools()->url(array("lang" => $this->language, "act" => "login"), "coreshop_user")?>"><?=$this->translate("Login")?></a></li>
    </ol>
            ...
            <div class="col-sm-6">
                ...
                <div class="panel panel-smart">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- Login Form Starts -->
                        <form class="form-inline" role="form" method="post" action="<?=\CoreShop::getTools()->url(array("lang" => $this->language, "act" => "login"), "coreshop_user")?>">
                            <input type="hidden" name="_redirect" value="<?=\CoreShop::getTools()->url(array("lang" =>  $this->language), "coreshop_index")?>" />
            ...
            <div class="col-sm-6">
                ...
                <div class="panel panel-smart">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?=\CoreShop::getTools()->url(array("lang" => $this->language, "act" => "register"), "coreshop_user")?>" class="btn btn-black">
