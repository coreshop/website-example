...
<div class="col-md-3">
    ...
    <?php if($this->filter instanceof CoreShop\Model\Product\Filter) {
        ?>
        <form class="form" action="<?=$this->category->getCategoryUrl($this->language);?>" method="get">
        <?php
        $filters = "";
...
<!-- Special Products Starts -->
    ...
    <!-- Special Product #3 Starts -->
        <li class="clearfix">
            <img src="/static/images/product-images/spl-product-img3.jpg" alt="Special product" class="img-responsive" />
            <h5><a href="#">Olympus Digital Camera</a></h5>
            <div class="price">
                <span class="price-new">$199.50</span>
                <span class="price-old">$249.50</span>
...
<!-- Banner #1 Starts -->
    <img src="/static/images/banners/side-banner1.jpg" alt="Side Banner" class="img-responsive" />
    <br>
<!-- Banner #1 Ends -->
