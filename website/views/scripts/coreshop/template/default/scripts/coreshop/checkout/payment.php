<div class="container shop checkout checkout-step-5">
    ...
    <form action="<?=$this->url(array("act" => "payment", "lang" => $this->language), "coreshop_checkout", true)?>" method="post">
        <div class="panel panel-smart">
            ...
            <div class="panel-body payment-options">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <a href="<?=$this->url(array("lang" => $this->language, "act" => "shipping"), "coreshop_checkout", true)?>" class="btn btn-default pull-left">
                            <?=$this->translate("Back")?>
                        </a>
